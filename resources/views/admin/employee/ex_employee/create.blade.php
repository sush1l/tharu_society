        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-style mb-30">
                    <form action="{{route('admin.exEmployee.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="designation" name="designation"
                                   ...
                                   placeholder="Designation (Nepali)" value="{{old('designation')}}">
                            @error('designation')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="department" name="department"
                                   ...
                                   placeholder="Department (English)" value="{{old('department')}}">
                            @error('department')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="joining_date" name="joining_date"
                                   ...
                                   value="{{old('joining_date')}}" placeholder="YYYY-MM-DD">
                            @error('joining_date')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="leaving_date" name="leaving_date"
                                   ...
                                   value="{{old('leaving_date')}}" placeholder="YYYY-MM-DD">
                            @error('leaving_date')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="radio-style-1">
                            ...
                            <input type="radio" id="chief" name="is_chief"
                                   ...
                                   value="1"@checked(old('is_chief') == 1) >
                            ...
                            <input type="radio" id="chief" name="is_chief"
                                   class="@error('is_chief') is-invalid @enderror"
                                   value="0" @checked(old('is_chief') == 0) >
