            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="date" id="date" name="date" value="{{old('date',$job->date)}}">
                        @error('date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="date" id="end_date" name="end_date" value="{{old('end_date', $job->end_date)}}">
                        @error('end_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="number" id="position" name="position" value="{{old('position',$job->position)}}">
                        @error('position')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="summernote">{{old('description',$job->description)}}</textarea>
                        @error('description')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
