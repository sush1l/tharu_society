            ...
            <div class="row">
                        ...
                        <select name="report_category_id" id="report_category_id" class="form-control">
                            ...
                            @foreach ($reportCategories as $reportCategory)
                                <option value="{{ $reportCategory->id }}"
                                    {{ old('report_category_id', $report->report_category_id) == $reportCategory->id ? 'selected' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="summernote">{{ old('description', $report->description) }}</textarea>
                        @error('description')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                @if (config('default.dual_language'))
                    <div class="col-md-12">
                        <div class="input-style-1">
                            ...
                            <textarea name="description_en" id="description_en" cols="30" rows="10" class="summernote">{{ old('description_en', $report->description_en) }}</textarea>
