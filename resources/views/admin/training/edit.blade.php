            ...
            <div class="row">
                        ...
                        <select name="training_category_id" id="training_category_id" class="form-control">
                            ...
                            @foreach ($trainingCategories as $trainingCategory)
                                <option value="{{ $trainingCategory->id }}"
                                    {{ old('training_category_id', $training->training_category_id) == $trainingCategory->id ? 'selected' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="summernote">{{ old('description', $training->description) }}</textarea>
                        @error('description')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                @if (config('default.dual_language'))
                    <div class="col-md-12">
                        <div class="input-style-1">
                            ...
                            <textarea name="description_en" id="description_en" cols="30" rows="10" class="summernote">{{ old('description_en', $training->description_en) }}</textarea>
