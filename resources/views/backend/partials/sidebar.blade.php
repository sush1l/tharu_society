...
{{--            @endcan--}}
 ...
 --}}
            ...
            <li class="nav-item nav-item-has-children">
                <a
                    href="#"
                    class="{{request()->is('admin/membership/*') ? '' : 'collapsed'}}"
                    data-bs-toggle="collapse"
                    data-bs-target="#membershipCategory"
                    aria-controls="Report"
                    aria-expanded="{{request()->is('admin/membership/*')}}"
                    aria-label="Toggle navigation"
                >
          <span class="icon">
           <i class="mdi mdi-wallet-membership"></i>
            ...
            <li class="nav-item nav-item-has-children">
                <a
                    href="#"
                    class="{{request()->is('admin/job/*') ? '' : 'collapsed'}}"
                    data-bs-toggle="collapse"
                    data-bs-target="#addCity"
                    aria-controls="Report"
                    aria-expanded="{{request()->is('admin/job/*')}}"
                    aria-label="Toggle navigation"
                >
          <span class="icon">
           <i class="mdi mdi-wallet-membership"></i>
                ...
                <ul id="addCity"
                    class="collapse dropdown-nav {{request()->is('admin/job/*') ? 'show' : ''}}">
                    <li>
