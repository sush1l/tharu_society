            ...
            <div class="row g-3">
                <div class="row">
                    <p data-aos="fade-up" data-wow-delay="0.1s"
                        style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;" class="fw-bold mb-3">
                        We'd love to hear from you and appreciate your patience as our dedicated volunteers strive to
                        respond to your message. We'll get back to you as soon as possible, and we truly
                            ...
                            <form class="row g-3 mx-4 my-4 " method="post" action="{{ route('contact.store') }}">
                                ...
                                <div class="col-md-12">
                                    <label for="message" class="form-label">Message <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="message" name="message" placeholder="Message" rows="5">{{ old('message') }}</textarea>
                                    @error('message')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                    ...
                    <div data-aos="fade-up" class="col-lg-5 col-md-5">
                        ...
                        <div class="address mt-3">
                            ...
                            <p><b>Email:</b> <a href="mailto:{{ $header->office_email }}">{{ $header->office_email }}</a>
                            </p>
