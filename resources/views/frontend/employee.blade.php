...
@section('content')
    ...
    <div class="container-fluid mt-2">
        <div data-aos="fade-up" class="well-heading" style="border-left: 10px solid #b31b1b; position: relative;background-color: {{$colors->nav}};">
        ...
        <div class="row">
            <div data-aos="fade-up" class="col-md-12">
                <div id="team_card" class="card-container">
                    <img data-aos="fade-up" class="rounded" src="{{$employees->first()->photo ?? ''}}" height="120" weight="120"
