        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{Route::currentRouteName() == 'LaravelUpdater::final' ? 'active' : ''}} {{-- isActive('LaravelUpdater::final') --}}">
                        <i class="step__icon fa fa-database" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{Route::currentRouteName() == 'LaravelUpdater::overview' ? 'active' : ''}} {{-- isActive('LaravelUpdater::overview') --}}">
                        <i class="step__icon fa fa-reorder" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{Route::currentRouteName() === 'LaravelUpdater::welcome' ? 'active' : ''}} {{-- isActive('LaravelUpdater::welcome') --}}">
