        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{\Route::currentRouteName() == 'LaravelInstaller::final' ? 'active' : ''}} {{-- isActive('LaravelInstaller::final') --}}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{(\Route::currentRouteName() == 'LaravelInstaller::environment') ||
                    (\Route::currentRouteName() == 'LaravelInstaller::environmentWizard') ||
                    (\Route::currentRouteName() == 'LaravelInstaller::environmentClassic') ? 'active' : ''}}
                     {{-- isActive('LaravelInstaller::environment')--}}
                     {{-- isActive('LaravelInstaller::environmentWizard')--}}
                     {{-- isActive('LaravelInstaller::environmentClassic')--}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{\Route::currentRouteName() == 'LaravelInstaller::permissions' ? 'active' : ''}}  {{-- isActive('LaravelInstaller::permissions') --}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{\Route::currentRouteName() == 'LaravelInstaller::requirements' ? 'active' : ''}} {{-- isActive('LaravelInstaller::requirements') --}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item  {{\Route::currentRouteName() == 'LaravelInstaller::welcome' ? 'active' : ''}} {{-- isActive('LaravelInstaller::welcome') --}}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
